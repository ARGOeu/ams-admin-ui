...
class SubTable extends React.Component {
    constructor(props) {
        ...
        if (this.authen.isLogged()) {
            this.state = {
                ...
                subs: this.apiGetSubs(window.location.hash.substring(1)),
                isServiceAdmin: this.authen.isServiceAdmin(),
                isConsumer: this.authen.isConsumer(),
                isProjectAdmin: this.authen.isProjectAdmin()
            };
    ...
    apiGetProjects() {
        if (this.state.isServiceAdmin) {
            ...
            this.state.isProjectAdmin === true 
        ) {
                ...
                <div className="row  mb-2">
                    ...
                    <div className="col">
                        ...
                        <Link
                            ...
                            to={"/subs/create#" + this.state.value}
                        >
                            <FontAwesomeIcon
                                className="mr-2"
                                icon="plus"
