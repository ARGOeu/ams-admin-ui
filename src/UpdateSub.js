...
class UpdateSub extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      pushRetryPolicy: "",
      pushRetryInterval: "",
      errors: { pushEndpoint: "", ack: "", retryInterval: "", retryPolicy: "" }
    };
    ...
    this.DM.subGet(projectName, subName).then(r => {
      if (r.done) {
        ...
        if (r.data.pushConfig.retryPolicy.hasOwnProperty("interval")) {
          pushRetryInterval = r.data.pushConfig.pushRetryPolicy.interval;
        }
  ...
  validateRetryInterval(value) {
    ...
    if (value !== "") {
      if (isNaN(value) || parseInt(value) < 300) {
        errors.retryInterval = "Please enter a numeric value larger than 300";
      } else {
  ...
  validateAck(value) {
    let errors = this.state.errors;
    if (value !== "") {
      if (isNaN(value) || (parseInt(value) < 0 || parseInt(value) > 600)) {
  ...
  doModAck(project, sub) {
    this.DM.subModAck(project, sub, { ackDeadlineSeconds: parseInt(this.state.ackDeadlineSeconds) }).then(done=>{
                ...
                <form onSubmit={this.handleSubmit}>
                  ...
                  <div className="form-control-group">
                    ...
                    <input
                      ...
                      value={this.state.ackDeadlineSeconds}
                    />
                  ...
                  <div className="form-control-group">
                    ...
                    <input
                      ...
                      className="form-control"
                      onChange={this.handlePushEndpoint}
                  ...
                  <div className="form-control-group">
                    ...
                    <input
                      id="inp-push-endpoint"
                      className="form-control"
                      onChange={this.handlePushRetryPolicy}
                      value={this.state.pushRetryPolicy}
                    />
                  </div>

                  <div className="form-control-group">
                    <label>Push Linear activity internal:</label>
                    <input
                      id="inp-push-endpoint"
                      className="form-control"
                      onChange={this.handlePushRetryInterval}
                      value={this.state.pushRetryInterval}
                    />
                  </div>
